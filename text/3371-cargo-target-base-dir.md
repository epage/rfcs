...
1. Not having to find and clean all `target/` dirs everywhere while not having all projects collide (which is the effect of setting `CARGO_TARGET_DIR` globally) ([rust-lang/cargo#12633](https://github.com/rust-lang/cargo/issues/12633) will also help)
